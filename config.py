...
class ConfigManager:
    def __init__(self, config_file: str = "pipeline-config.json"):
    ...
    def _dict_to_config(self, data: Dict[str, Any]) -> Config:
        ...
        config.paths.data_dir = path_data.get("data_dir", str(Path(__file__).parent / "clash-of-clans-data/data/home"))
        config.paths.schedule_file = path_data.get("schedule_file", str(Path(__file__).parent / "schedule.json"))
        config.paths.village_export_file = path_data.get("village_export_file", str(Path(__file__).parent / "village_export.json"))
        config.paths.completed_tasks_file = path_data.get("completed_tasks_file", str(Path(__file__).parent / "completed_tasks.json"))
        config.paths.metadata_cache_file = path_data.get("metadata_cache_file", str(Path(__file__).parent / "parsed_metadata.json"))
        config.paths.backup_dir = path_data.get("backup_dir", str(Path(__file__).parent / "backups"))
